  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <header className="sticky top-0 z-50 bg-[#fbfbfb]/85 backdrop-blur-md border-b border-neutral-100 px-6 py-4 flex items-center justify-between max-w-7xl mx-auto w-full">
        <nav className="flex items-center gap-1 sm:gap-4 text-xs font-mono tracking-wider text-neutral-600">
          <a href="#about" onClick={(e) => handleScroll(e, "about")} className="hover:text-black transition-colors px-1 sm:px-2 py-1">
            [About]
          </a>
          <a href="#pricing" onClick={(e) => handleScroll(e, "pricing")} className="hover:text-black transition-colors px-1 sm:px-2 py-1">
            [Pricing]
          </a>
        </nav>
        ...
        <nav className="flex items-center gap-1 sm:gap-4 text-xs font-mono tracking-wider text-neutral-600">
          <a href="#case-studies" onClick={(e) => handleScroll(e, "case-studies")} className="hover:text-black transition-colors px-1 sm:px-2 py-1">
            [Case Studies]
          </a>
          <a href="#contact" onClick={(e) => handleScroll(e, "contact")} className="hover:text-black transition-colors px-1 sm:px-2 py-1">
            [Contact]
          </a>
        </nav>
      </header>

      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-12 space-y-32">
        {/* HERO SECTION */}
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-4 gap-12 max-w-5xl mx-auto pb-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-xs font-mono text-neutral-500">
              <li>
                <a href="#about" onClick={(e) => handleScroll(e, "about")} className="hover:text-black transition-colors">
                  [Home]
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#pricing" onClick={(e) => handleScroll(e, "pricing")} className="hover:text-black transition-colors">
                  [Pricing]
                </a>
              </li>
              <li>
                <a href="#case-studies" onClick={(e) => handleScroll(e, "case-studies")} className="hover:text-black transition-colors">
                  [Case Studies]
                </a>
              </li>
              <li>
